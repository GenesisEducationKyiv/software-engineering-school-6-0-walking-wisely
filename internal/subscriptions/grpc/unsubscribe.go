...
func (s *SubscriptionService) Unsubscribe(ctx context.Context, req *subscriptionv1.UnsubscribeRequest) (*subscriptionv1.UnsubscribeResponse, error) {
	...
	return &subscriptionv1.UnsubscribeResponse{}, nil
}
